...
theme.tasklist_floating_icon = "~/.config/awesome/icons/layouts/floating.png"
...
theme.delightful_error               = "~/.config/awesome/icons/error.png"

-- icons for delightful battery widget
battery_icon_dir                     = "~/.config/awesome/icons/battery"
...
volume_icon_dir           = "~/.config/awesome/icons/volume"
